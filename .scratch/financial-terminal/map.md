...
- **현재 frontier**: [19 - F10 Broker Sync](./issues/19-build-broker-sync.md) (18 F9 resolved; F6 뒤 P3 병렬 group의 남은 한 축 — depends on 15 F6 resolved, eligible). 그 뒤 [20 - F11 release integration](./issues/20-integrate-release-artifacts.md)이 F5·F7·F9·F10 완료를 기다린다.
