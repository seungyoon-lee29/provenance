...
- **현재 frontier**: [18 - F9 Broker Paper execution](./issues/18-build-broker-paper-execution.md) (17 F8 resolved; [19 - F10 Broker Sync](./issues/19-build-broker-sync.md)도 eligible — P3 병렬 group)
