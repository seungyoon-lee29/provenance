...
- [ ] **B2 simulation-v1 simulator** — `internal/simulator.ts`: 관측 유효성 게이트(eventTime>acceptedAt·venue/session·freshness·data clock), volume 10%·slippage·limit·tick/lot·deterministic allocation, partial→filled 전이, DAY/GTC expiry. literal: buy 100.07/sell 99.93, volume 상한, limit 0-fill, data-clock 지연.
