...
- [~] **B5 presentation/browser (일부 완료, 게이트 여전히 open)**
  ...
  - [ ] **미완(게이트 open)**: 실제 page/route에 F4 패널 mount + Playwright browser 렌더(리터럴 DOM), explicit-unavailable screenshot 산출물, `withDeadline`를 read 경로에 실배선. → F4 resolved 전 필수.
